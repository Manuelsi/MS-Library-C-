...
namespace NullrefLib.Collections {
	...
	public class PriorityQueue<T> {
		...
		public void Enqueue(T item, float cost) => queue.Add((item, cost));

		public void Enqueue((T item, float weight) item) => queue.Add(item);

		public T Dequeue() => greaterFirst ? SearchGreater().item : SearchLesser().item;
